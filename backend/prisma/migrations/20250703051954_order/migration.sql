...
INSERT INTO "new_Order" ("createdAt", "customerId", "delete", "description", "groupBuyId", "id", "quantity", "status", "updatedAt") SELECT "createdAt", "customerId", "delete", "description", "groupBuyId", "id", "quantity", "status", "updatedAt" FROM "Order";
DROP TABLE "Order";
